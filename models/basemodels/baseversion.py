...
class BaseVersion(object):
    ...
    def load_schema(self):
        try:
            ...
            #from copow.migrations.schemas.version_schema import version_relations as relations
            schema = reload(copow.migrations.schemas.version_schema)
            self.schema = schema.__dict__["version"]
            self.relations = schema.__dict__["version_relations"]

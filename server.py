...
def init_controllers(app):
	...
	print("-"*50)
	print("  -> GET 	/controller 			=>	controller.list()			=> WORKS")
	print("  -> GET 	/controller/id			=>	controller.show(id)			=> WORKS")
	print("  -> GET 	/controller/id/update	=>	controller.update_form(id)	=> Wip")
	print("  -> POST 	/controller	 			=>	HTTP 501, not implemented.	=> NA")
	print("  -> POST 	/controller/id			=>	controller.update(id)		=> Wip")
	print("  -> DELETE 	/controllers			=>	controller.delete_all()		=> NiY")
	print("  -> DELETE 	/controller/id			=>	controller.delete(id)		=> NiY")
	print("  -> PUT 	/controllers			=>	controller.create()			=> NiY")
	print("  -> PUT 	/controller/id			=>	HTTP 501, not implemented 	=> NA")
	print("-"*50)
